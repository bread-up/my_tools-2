...
# install package
apt update -y
apt install sudo git-core gnupg flex bison gperf build-essential zip curl zlib1g-dev gcc-multilib g++-multilib libc6-dev-i386 lib32ncurses5-dev x11proto-core-dev libx11-dev lib32z-dev libgl1-mesa-dev libxml2-utils xsltproc libncurses5 unzip -y
# run repo
...
# Init repo
repo init --depth=1 -u https://github.com/bread-up/android -b 10.0
